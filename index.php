...
<!-- body part starts here -->
    <div class="container" style=" background-image: linear-gradient(#080A52, #63BFD1);height:1500px;">
        ...
        <div class="container px-4 text-center" style="width:80%;padding:20px;">
            <div class="row gx-5 " style="height:600px;">
                <div class="col" style="border:4px solid #475A5F;border-radius:10px;margin:10px;background-color:white;height:450px;width:50%">
                    <div><img src="httpdocs/images/images.png" alt="basic" height="100px"width="50%"></div>
                    ...
                    <div>Local guid</div>
                    <div style="margin-top:10px;"><h3>$ 39.75</h3></div>
                    <div><a class="btn btn-primary" href="signup.php" role="button" style="margin-top:20px">Sign Up</a></div>
                </div>
                
                <div class="col" style="border:4px solid #475A5F;border-radius:10px;margin:10px;background-color:white;height:450px;width:50%" >
                    <div><img src="httpdocs/images/standard1.jpg" alt="standard"height="100px" width="50%"style="padding:5x"></div>
                    ...
                    <div>Free lunch and dinner</div>
                    <div>Local guid</div>
                    <div style="margin-top:10px;"><h3>$ 59.75</h3></div>
                    <div>
                    <a class="btn btn-primary" href="signup.php" role="button" style="margin-top:20px">Sign Up</a>
                    </div>
                </div>
                <div class="col" style="border:4px solid #475A5F;border-radius:10px;margin:10px;background-color:white;height:450px;width:50%">
                    <div><img src="httpdocs/images/premium.jpg" alt="premium" width="40%" height="100px" ></div>
                    ...
                    <div>Free lunch and dinner</div>
                    <div>Local guid</div>
                    <div style="margin-top:10px;"><h3>$ 180.75</h3></div>
                    <div><a class="btn btn-primary" href="signup.php" role="button" style="margin-top:20px">Sign Up</a></div>
                </div>
